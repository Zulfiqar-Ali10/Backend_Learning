...
router.post("/", async (req, res) => {
    const {tittle, heading, price} = req.body;
    try{
       let newEcommerce = new Ecommerce({tittle, heading, price});
...
router.put("/:id", async (req, res) => {    
    ...
    try {
        ...
        if(tittle) Ecommerces.tittle = tittle;
        if(heading) Ecommerces.heading = heading;
